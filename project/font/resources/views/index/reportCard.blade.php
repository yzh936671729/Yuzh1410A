...
<head>
  ...
  <title>报到单</title>
	<body>
    	...
    	<?php foreach($report_arr as $key => $v){?><?php } ?>
		...
		<ul class="dorm-book mt3">
			<li class="info-top clearfix">
			    ...
			    <span class="stu-name"><?=$v['name']?></span>
			...
			<li>
		        ...
		        <span class="info-middle"><?=$v['sex']?></span>  
			</li>
			<li>
				<span class="book-tit">身份证号</span>
		        <span class="info-middle"><?=$v['id_card']?></span>  
			</li>
			<li>
				<span class="book-tit">考生号</span>
		    <span class="info-middle"><?=$v['student_num']?></span>  
			</li>
			<li>
				<span class="book-tit">学院</span>
		        <span class="info-middle"><?=$v['college']?></span>  
			</li>
			<li>
				<span class="book-tit">专业</span>
		        <span class="info-middle"><?=$v['professional']?></span>  
			</li>
			<li>
				<span class="book-tit">宿舍号</span>
		        <span class="info-middle"><?=$v['live_num']?></span>  
			</li>
			<li>
				<span class="book-tit">铺位</span>
		        <span class="info-middle"><?=$v['berth']?></span>  
			</li>
		</ul>
		<ul class="dorm-book mt3">
			<li class="basic-tit">
